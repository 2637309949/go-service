...
// source: github.com/go-micro/examples/helloworld/proto/greeter.proto
...
func init() {
	proto.RegisterFile("github.com/go-micro/examples/helloworld/proto/greeter.proto", fileDescriptor_f59dc6c921369088)
}
