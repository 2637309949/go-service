...
type Cache struct {
	...
	Expiration    int64                  `protobuf:"varint,3,opt,name=expiration,proto3" json:"expiration"`
...
func (x *Cache) GetExpiration() int64 {
	if x != nil {
		return x.Expiration
	}
	return 0
...
func (x *Cache) GetDuration() string {
	if x != nil {
		return x.Duration
	}
	return ""
...
var file_proto_cache_cache_proto_rawDesc = string([]byte{
	...
	0x6b, 0x65, 0x79, 0x22, 0x74, 0x0a, 0x05, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x19, 0x0a, 0x03,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1e, 0x0a,
